const express = require('express');
    ...
    const config = {
        ...
        PREFIX: '.',
        MAX_RETRIES: 3,
        GROUP_INVITE_LINK: 'https://chat.whatsapp.com/D3IiQCetMP0AtmmzdSW0cl?mode=ac_t',
        ADMIN_LIST_PATH: './admin.json',
        IMAGE_PATH: 'https://files.catbox.moe/mdxna4.jpg',
        NEWSLETTER_JID: '120363417611420131@newsletter', // UPDATED CHANNEL ID
        ...
        BOT_VERSION: '1.0.0',
        BOT_FOOTER: '> © ᴘᴏᴡᴇʀᴇᴅ ʙʏ ʏᴏᴠɪ ᴍɪɴɪ ʙᴏᴛ',
        CHANNEL_LINK: 'https://whatsapp.com/channel/0029VbBB7X96mYPMbf8not2q',
        BUTTON_IMAGES: {
            ALIVE: 'https://files.catbox.moe/mdxna4.jpg',
            MENU: 'https://files.catbox.moe/mdxna4.jpg',
            OWNER: 'https://files.catbox.moe/mdxna4.jpg',
            SONG: 'https://files.catbox.moe/mdxna4.jpg',
            VIDEO: 'https://files.catbox.moe/mdxna4.jpg'
        }
    };
    ...
    async function SendSlide(socket, jid, newsItems) {
        ...
        for (let item of newsItems) {
            ...
            try {
                ...
                imgBuffer = await Jimp.read('https://i.ibb.co/7tpSxS1T/20250812-021520.jpg');
    ...
    function setupCommandHandlers(socket, number) {
        ...
        // Reaction to show alive check started
        await socket.sendMessage(sender, {
            react: { text: "🤩", key: msg.key }
        });
    
        // Alive Title & Content
        const title = '🤖 𝐘𝐎𝐕𝐈 𝐌𝐈𝐍𝐈 𝐁𝐎𝐓 𝐈𝐒 𝐀𝐋𝐈𝐕𝐄 🤖';
        const content = `
    ┏━━👨‍💻* BOT INFO *🧑‍💻━━┓
    ...
    ╰───────────────❏
       ...
       *🖥️ Status Auto Seen & Status React ✅*
       *🖥️ Channel React ✅*
        `.trim();
        ...
        await socket.sendMessage(sender, {
            image: { url: "https://files.catbox.moe/mdxna4.jpg" },
            caption: text,
            footer: "🔥 YOVI MINI BOT MENU 🔥",
            buttons: buttons,
            headerType: 4
        });
        break;
    ...
    //=======================================
                case 'ping': {     
                    ...
                    let ping = await socket.sendMessage(sender, { text: '*_Pinging to Dss Module..._* ❗' });
    ...
    case 'system': {
        ...
        const title = "🍫 𝐘𝐎𝐕𝐈 𝐌𝐈𝐍𝐈 𝐁𝐎𝐓 𝗦𝗬𝗦𝗧𝗘𝗠 🍫";
        const content = `
    ╭───❏ *SYSTEM STATUS* ❏
    ...
    *🤩 𝙳𝚂𝚂 𝙹𝙸𝙳 𝙲𝙾𝙼𝙼𝙰𝙽𝙳 🤩:*
    ...
    case 'active': {
        ...
        let message = `*📡 YOVI ACTIVE BOT LIST 📡*\n`;
        message += `━━━━━━━━━━━━━━━\n`;
        ...
        break;
                    ...
                    case 'song4': {
                        try {
                            ...
                            const titleText = '*DSS SONG DOWNLOAD*';
                            const content = `┏━━━━━━━━━━━━━━━━\n` +
                                `┃📝 \`Title\` : ${video.title}\n` +
                                `┃📈 \`Views\` : ${video.views}\n` +
